...
mlflow.set_tracking_uri(
    "file:///C:/Users/mathi/Documents/University/Aarhus University/MSc Computer Engineering/Semester 1/mlruns"
)
...
'''
def runGridPoint(gridSearchArray : list, id : int):
    # Affected by Grid Search
    BATCH_SIZE = int(gridSearchArray[0])
